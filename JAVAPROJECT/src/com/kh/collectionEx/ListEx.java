...
public class ListEx {
    ...
    * */
    ...
    public static void main(String[] args) {
        /*
        * 두 표현의 메모리 사용량이나 실행 시간에는 큰 차이가 ㅇ벗음
