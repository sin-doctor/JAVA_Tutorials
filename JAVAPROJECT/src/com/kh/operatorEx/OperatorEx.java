...
public class OperatorEx {
    ...
    * 변수명++ // = 변수명에 +1외외에 대입하거나 값을 넣어줘야 할 일 X
    *
    * int result = ++변수명; // 변수명 +1을 해준다음 +1이 된 변수명을 result 넣어줌
    * --- 위 셋은 변수명과 result의 결과값이 같음
    *
    * int result = 변수명++;
    * -- result 에 +1을 안한 변수명을 넣어주고 , 그다음에 변수명에 +1을 해주기 때문에
    *    result 가 변수명보다 값이 1 적음
    *
    * 삼항 연산자(Ternary Operators)
    * (     )? true : false
    *       조건이 참이면 첫 번째 값 반환 거짓이면 두 번쨰 값 반환
    *
    * 기타 연산자
    * . 멤버 접근 연사자           ex.method1() ex 내부에 있는 method1() 기능 호출
