...
// Constant : 끊임없는 , 변하지 않는 값 끝임없이 똑같은 값 = 상수
public class Constant {
    //보통 상수의 경우 어디서든 사용할 수 있도록 static을 앞에 붙여줌
    // static이 붙은 상수나 변수는 어디서든 접근 가능하기 때문에 글로벌 상수 / 글로벌 변수

    public static final int NUMBER = 100;

    public static void main(String[] args) {
        /*
        * 지역변수 - 이미 선언된 메서드의 내부 범위로 접근이 제한되기 때문에 접근 제한자를 추가로 지정
