...
public class Nation {
  ...
  //  private                             String name;
    ...
    /*기능(메서드) 안에는 매개변수(파라미터) 지역변수 접근제한 사용 불가 */
    // 기능(메서드) 종류 : 기본 생성자 매개변수생성자 setter getter void메서드 return메서드 main메서드 toString
    // 단축키 Alt + Insert
    ...
    // 예를 들어, 이름과 나이만 전달받길 원한다면 setName, setAge를 사용
    ...
    // 값에 저장할 때는 매개변수생성자 or setter 둘 중 선택해서 사용가능
